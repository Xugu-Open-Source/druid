...
public class XuGuCreateEventStatement extends XuGuStatementImpl implements SQLAlterStatement {
    private SQLName            definer;
    private SQLName            name;

    private boolean            ifNotExists;

    private XuGuEventSchedule schedule;
    ...
    public XuGuCreateEventStatement() {
        setDbType(JdbcConstants.XUGU);
    }
    ...
    public XuGuEventSchedule getSchedule() {
        return schedule;
    }

    public void setSchedule(XuGuEventSchedule schedule) {
        if (schedule != null) {
