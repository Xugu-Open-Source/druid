...
public class XuGuExportParameterVisitor extends XuGuOutputVisitor implements ExportParameterVisitor {
    ...
    public XuGuExportParameterVisitor(List<Object> parameters, Appendable appender, boolean wantParameterizedOutput){
        super(appender, true);
        this.parameters = parameters;
        this.requireParameterizedOutput = wantParameterizedOutput;
    }

    public XuGuExportParameterVisitor() {
        this(new ArrayList<Object>());
    }

    public XuGuExportParameterVisitor(List<Object> parameters) {
        this(parameters, null, false);
    }

    public XuGuExportParameterVisitor(final Appendable appender) {
