 ...
 */
public class XuGuShowColumnOutpuVisitor extends XuGuOutputVisitor {
    public XuGuShowColumnOutpuVisitor(Appendable appender) {
        super(appender);
    }
        ...
        for (SQLTableElement element : x.getTableElementList()) {
            if (element instanceof SQLColumnDefinition) {
                ...
                if (column.getDefaultExpr() == null) {
                    ...
                    String defaultVal = SQLUtils.toXuGuString(column.getDefaultExpr());
