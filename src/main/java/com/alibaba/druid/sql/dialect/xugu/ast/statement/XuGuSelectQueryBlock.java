...
public class XuGuSelectQueryBlock extends SQLSelectQueryBlock implements XuGuObject {
    ...
    public XuGuSelectGroupByClause getXgGroupBy() {
        return xgGroupBy;
    }

    public void setXgGroupBy(XuGuSelectGroupByClause xgGroupBy) {
        if (xgGroupBy != null) {
            xgGroupBy.setParent(this);
        }
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((top == null) ? 1231 : 1237);
    ...
    public boolean equals(Object obj) {
        ...
        XuGuSelectQueryBlock other = (XuGuSelectQueryBlock) obj;
        ...
        if (forReadOnly != other.forReadOnly) {
            return false;
        }

        if (xgGroupBy == null) {
            if (other.xgGroupBy != null) {
                return false;
            }

        } else if (!xgGroupBy.equals(other.xgGroupBy)) {
            return false;
        }

        if (parallelConst == null) {
            if (other.parallelConst != null) {
                return false;
            }

        } else if (!parallelConst.equals(other.parallelConst)) {
            return false;
        }
