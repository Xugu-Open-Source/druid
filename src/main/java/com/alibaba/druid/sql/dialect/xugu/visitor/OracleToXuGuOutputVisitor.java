 ...
 */
public class OracleToXuGuOutputVisitor extends XuGuOutputVisitor implements OracleASTVisitor {
    public OracleToXuGuOutputVisitor(Appendable appender) {
        super(appender);
    }

    public OracleToXuGuOutputVisitor(Appendable appender, boolean parameterized) {
