...
public class XuGuCaseStatement extends XuGuStatementImpl {
	...
	//when statement list
	private List<XuGuWhenStatement> whenList = new ArrayList<XuGuWhenStatement>();
	//else statement
	...
	public List<XuGuWhenStatement> getWhenList() {
		return whenList;
	}

	public void setWhenList(List<XuGuWhenStatement> whenList) {
		this.whenList = whenList;
	}
	
	public void addWhenStatement(XuGuWhenStatement stmt)
	{
