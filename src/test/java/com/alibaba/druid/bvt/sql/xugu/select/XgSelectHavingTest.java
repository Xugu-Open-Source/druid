...
public class XgSelectHavingTest extends TestCase {

    public void testHaving() {
        String sql = "SELECT region,NAME,SUM(amount) amo_sum,count(*) row_cou FROM TB_TOP GROUP BY region,NAME HAVING row_cou>1;";
