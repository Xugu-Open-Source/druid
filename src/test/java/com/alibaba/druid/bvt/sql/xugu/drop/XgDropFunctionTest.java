...
public class XgDropFunctionTest extends TestCase {

    public void testDropFunction() {
        String sql = "DROP FUNCTION func_parameterless;";
    ...
    public void testExists() {
        String sql = "DROP FUNCTION IF EXISTS func_parameterless;";
        List<SQLStatement> statementList = SQLUtils.parseStatements(sql, JdbcConstants.XUGU, true);
        SQLStatement stmt = statementList.get(0);
        SchemaStatVisitor visitor = SQLUtils.createSchemaStatVisitor(JdbcConstants.XUGU);
        stmt.accept(visitor);
    ...
    public void testCascade() {
        String sql = "DROP FUNCTION IF EXISTS func_parameterless CASCADE;";
        List<SQLStatement> statementList = SQLUtils.parseStatements(sql, JdbcConstants.XUGU, true);
        SQLStatement stmt = statementList.get(0);
        SchemaStatVisitor visitor = SQLUtils.createSchemaStatVisitor(JdbcConstants.XUGU);
        stmt.accept(visitor);
    ...
    public void testRestrict() {
        String sql = "DROP FUNCTION IF EXISTS func_parameterless RESTRICT;";
        List<SQLStatement> statementList = SQLUtils.parseStatements(sql, JdbcConstants.XUGU, true);
        SQLStatement stmt = statementList.get(0);
        SchemaStatVisitor visitor = SQLUtils.createSchemaStatVisitor(JdbcConstants.XUGU);
        stmt.accept(visitor);
