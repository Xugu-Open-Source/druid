...
public class XgInsertPartitionTest extends TestCase {
    ...
    public void testPartition() {
        String sql = "INSERT INTO tb_top_merge PARTITION (part1) VALUES (10, 1, 'one-1', 10);";
    ...
    public void testPartition_1() {
        String sql = "INSERT IGNORE INTO tb_top_merge PARTITION (part1) VALUES (10, 1, 'one-1', 10);";
        List<SQLStatement> statementList = SQLUtils.parseStatements(sql, JdbcConstants.XUGU, true);
        String xuGuString = SQLUtils.toSQLString(statementList, JdbcConstants.XUGU);
        System.out.println(xuGuString);
        assertEquals(sql.replaceAll("\\s+", " ").trim(), xuGuString.replaceAll("\\s+", " ").trim());
    ...
    public void testSubPartition() {
        String sql = "INSERT INTO tb_top_merge SUBPARTITION (SUBPART1) VALUES (11, 1, 'one-1', 10);";
        List<SQLStatement> statementList = SQLUtils.parseStatements(sql, JdbcConstants.XUGU, true);
        String xuGuString = SQLUtils.toSQLString(statementList, JdbcConstants.XUGU);
        System.out.println(xuGuString);
        assertEquals(sql.replaceAll("\\s+", " ").trim(), xuGuString.replaceAll("\\s+", " ").trim());
    ...
    public void testSubPartition_1() {
        String sql = "INSERT IGNORE INTO tb_top_merge SUBPARTITION (SUBPART1) VALUES (11, 1, 'one-1', 10);";
        List<SQLStatement> statementList = SQLUtils.parseStatements(sql, JdbcConstants.XUGU, true);
        String xuGuString = SQLUtils.toSQLString(statementList, JdbcConstants.XUGU);
        System.out.println(xuGuString);
        assertEquals(sql.replaceAll("\\s+", " ").trim(), xuGuString.replaceAll("\\s+", " ").trim());
