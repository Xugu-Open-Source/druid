...
public class XuGuPartitionSingle extends SQLPartitionSingle implements XuGuObject {
    ...
    @Override
    public XuGuPartitionSingle clone() {
        XuGuPartitionSingle x = new XuGuPartitionSingle();
