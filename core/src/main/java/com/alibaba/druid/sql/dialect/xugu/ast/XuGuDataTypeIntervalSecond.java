...
public class XuGuDataTypeIntervalSecond extends SQLDataTypeImpl implements XuGuObject {
    private boolean toSecond;

    protected final List<SQLExpr> fractionalSeconds = new ArrayList<SQLExpr>();

    public XuGuDataTypeIntervalSecond() {
        this.setName("INTERVAL SECOND");
    }
    ...
    public XuGuDataTypeIntervalSecond clone() {
        XuGuDataTypeIntervalSecond x = new XuGuDataTypeIntervalSecond();
