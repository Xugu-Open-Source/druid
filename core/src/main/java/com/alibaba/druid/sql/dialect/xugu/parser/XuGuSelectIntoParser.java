 ...
 */
public class XuGuSelectIntoParser extends SQLSelectParser {
    private List<SQLExpr> argsList;

    public XuGuSelectIntoParser(SQLExprParser exprParser) {
        super(exprParser);
    }

    public XuGuSelectIntoParser(String sql) {
        this(new XuGuExprParser(sql));
    }

    public XuGuSelectIntoStatement parseSelectInto() {
        SQLSelect select = select();
        XuGuSelectIntoStatement stmt = new XuGuSelectIntoStatement();
