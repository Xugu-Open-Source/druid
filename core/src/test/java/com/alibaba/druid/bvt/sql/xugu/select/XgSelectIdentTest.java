...
public class XgSelectIdentTest extends TestCase {

    public void testBoth() {
        String sql = "SELECT TRIM(BOTH 'O' FROM 'OOHELLO') FROM dual;";
    ...
    public void testBoth_1() {
        String sql = "SELECT TRIM(BOTH 'o' FROM name) FROM tb_top;";
        XuGuStatementParser parser = new XuGuStatementParser(sql);
        List<SQLStatement> sqlStatements = parser.parseStatementList();
        SQLStatement stmt = sqlStatements.get(0);
        XuGuSchemaStatVisitor visitor = new XuGuSchemaStatVisitor();
    ...
    public void testLeading() {
        String sql = "SELECT TRIM(LEADING 'O' FROM 'OOHELLO') FROM dual;";
        XuGuStatementParser parser = new XuGuStatementParser(sql);
        List<SQLStatement> sqlStatements = parser.parseStatementList();
        SQLStatement stmt = sqlStatements.get(0);
        XuGuSchemaStatVisitor visitor = new XuGuSchemaStatVisitor();
    ...
    public void testTrailing() {
        String sql = "SELECT TRIM(TRAILING 'O' FROM 'OOHELLO') FROM dual;";
        XuGuStatementParser parser = new XuGuStatementParser(sql);
        List<SQLStatement> sqlStatements = parser.parseStatementList();
        SQLStatement stmt = sqlStatements.get(0);
        XuGuSchemaStatVisitor visitor = new XuGuSchemaStatVisitor();
    ...
    public void testTrim() {
        String sql = "SELECT TRIM( 'O' FROM 'OOHELLO') FROM dual;";
        XuGuStatementParser parser = new XuGuStatementParser(sql);
        List<SQLStatement> sqlStatements = parser.parseStatementList();
        SQLStatement stmt = sqlStatements.get(0);
        XuGuSchemaStatVisitor visitor = new XuGuSchemaStatVisitor();
    ...
    public void testExtract() {
        String sql = "SELECT EXTRACT(YEAR FROM '2022-05-20 10:10:10'),EXTRACT(MONTH FROM '2022-05-20 10:10:10'),\n" +
